          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-3">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full border-white/20 hover:bg-white/10 hover:border-primary/50 bg-transparent hover:shadow-[0_0_15px_rgba(30,136,229,0.2)] transition-all duration-300"
                >
            ...
            <div className="space-y-6">
              <h3 className="font-semibold text-lg relative inline-block">
                Services
                <span className="absolute -bottom-1 left-0 w-12 h-0.5 bg-secondary"></span>
              </h3>
              <div className="space-y-3">
                <Link href="/ai-solutions" className="block text-white/80 hover:text-white hover:translate-x-1 transition-all duration-300 text-sm flex items-center">
                  <span className="w-1.5 h-1.5 bg-secondary/70 rounded-full mr-2"></span>
                  AI & Machine Learning
                </Link>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-sm group hover:translate-x-1 transition-all duration-300">
                  ...
                  <span className="text-white/80 group-hover:text-white transition-colors">+91 73874 01021</span>
                </div>
                <div className="flex items-center space-x-3 text-sm group hover:translate-x-1 transition-all duration-300">
                  <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shadow-inner">
                    <Mail className="w-4 h-4 text-secondary" />
                  </div>
                  <span className="text-white/80 group-hover:text-white transition-colors">Business@canosolutions.in</span>
                </div>
