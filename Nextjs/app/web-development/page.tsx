...
const portfolioProjects = [
  {
    ...
    image: "/imgs/Government Portal.jpeg",
  },
  {
    ...
    image: "/imgs/E-commerce Platform.jpeg",
  },
  {
    ...
    image: "/imgs/Educational Platform.jpeg",
  },
]
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-h1  font-bold text-textPrimary">
                Build Modern <span className="text-primary font-bold">Web Applications</span> That Drive Results
              </h1>
