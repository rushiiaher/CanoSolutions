...
export default function ContactPage() {
  const contactMethods = [
    ...
    },
    {
      ...
      contact: "hello@canosolutions.com",
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-6 bg-[#DF2E35]/10 text-[#DF2E35] border-[#DF2E35]/20">Get In Touch</Badge>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Let's Transform Your
              <span className="text-[#DF2E35]"> Business Together</span>
            </h1>
            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                <Card key={index} className="border-0 shadow-lg text-center bg-white">
                  <CardHeader>
                    <div className="w-16 h-16 bg-[#DF2E35]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                      <IconComponent className="h-8 w-8 text-[#DF2E35]" />
                    </div>
                  ...
                  <CardContent>
                    ...
                    <div className="text-sm text-gray-600">{method.availability}</div>
                  </CardContent>
                </Card>
              )
            })}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Book a Free Consultation</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">Choose the consultation that best fits your needs</p>
          </div>
                  ...
                  <ul className="space-y-2 mb-6">
                    {consultation.includes.map((item, idx) => (
                      <li key={idx} className="flex items-center text-sm text-gray-700">
                        <CheckCircle className="h-4 w-4 text-[#DF2E35] mr-2 flex-shrink-0" />
                        {item}
                      </li>
                    ))}
                  </ul>
